...
// ValidateAll checks the field values on LocalityEndpointsHealth with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// LocalityEndpointsHealthMultiError, or nil if none found.
func (m *LocalityEndpointsHealth) ValidateAll() error {
	return m.validate(true)
}

func (m *LocalityEndpointsHealth) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, LocalityEndpointsHealthValidationError{
					field:  "Locality",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
// LocalityEndpointsHealthMultiError is an error wrapping multiple validation
// errors returned by LocalityEndpointsHealth.ValidateAll() if the designated
// constraints aren't met.
type LocalityEndpointsHealthMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LocalityEndpointsHealthMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LocalityEndpointsHealthMultiError) AllErrors() []error { return m }
...
// ValidateAll checks the field values on ClusterEndpointsHealth with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ClusterEndpointsHealthMultiError, or nil if none found.
func (m *ClusterEndpointsHealth) ValidateAll() error {
	return m.validate(true)
}

func (m *ClusterEndpointsHealth) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetLocalityEndpointsHealth() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ClusterEndpointsHealthValidationError{
...
// ClusterEndpointsHealthMultiError is an error wrapping multiple validation
// errors returned by ClusterEndpointsHealth.ValidateAll() if the designated
// constraints aren't met.
type ClusterEndpointsHealthMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ClusterEndpointsHealthMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ClusterEndpointsHealthMultiError) AllErrors() []error { return m }
