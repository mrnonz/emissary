...
type Config struct {
	...
	UpdatePeriod *duration.Duration `protobuf:"bytes,2,opt,name=update_period,json=updatePeriod,proto3" json:"update_period,omitempty"`
}
...
func (x *Config) GetUpdatePeriod() *duration.Duration {
	if x != nil {
