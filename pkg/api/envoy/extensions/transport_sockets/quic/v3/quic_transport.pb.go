...
import (
	...
	v3 "github.com/datawire/ambassador/v2/pkg/api/envoy/extensions/transport_sockets/tls/v3"
...
type QuicDownstreamTransport struct {
	...
	// Default to true.
	EnableEarlyData *wrappers.BoolValue `protobuf:"bytes,2,opt,name=enable_early_data,json=enableEarlyData,proto3" json:"enable_early_data,omitempty"`
}
...
func (x *QuicDownstreamTransport) GetEnableEarlyData() *wrappers.BoolValue {
	if x != nil {
