...
func (in *AddedHeader) DeepCopyInto(out *AddedHeader) {
	*out = *in
	if in.Shorthand != nil {
		in, out := &in.Shorthand, &out.Shorthand
		*out = new(string)
		**out = **in
	}
	if in.Full != nil {
		in, out := &in.Full, &out.Full
		*out = new(AddedHeaderFull)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *AuthServiceSpec) DeepCopyInto(out *AuthServiceSpec) {
	*out = *in
	...
	if in.V3CircuitBreakers != nil {
		in, out := &in.V3CircuitBreakers, &out.V3CircuitBreakers
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DisableManglingAmbassadorID) DeepCopyInto(out *DisableManglingAmbassadorID) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DisableManglingAmbassadorID.
func (in *DisableManglingAmbassadorID) DeepCopy() *DisableManglingAmbassadorID {
	if in == nil {
		return nil
	}
	out := new(DisableManglingAmbassadorID)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TraceConfig) DeepCopyInto(out *TraceConfig) {
	*out = *in
	...
	if in.V3PropagationModes != nil {
		in, out := &in.V3PropagationModes, &out.V3PropagationModes
		*out = make([]v3alpha1.PropagationMode, len(*in))
		copy(*out, *in)
	}
}
